...
hyperparameters = dict(
    model_name=f"LMFDB_uniform_Matthews_Nsum_4_p{max_prime}",
    model_num=None,
    ...
    dataloader=dict(
        ...
        load_S4_S5_sums=f"LMFDB_Nsums_S4_S5_p{max_prime}.json",
        load_Bober_sums=f"Bober_sums/LMFDB{max_prime}.txt",
