...
hyperparameters = dict(
    model_name="triv_1_uniform_Matthews_NN_p1000",
    model_num=None,
    ...
    epochs="OPTIMIZE: lambda idx: int(idx) # discrete # tuple(range(1, 51))",
    optimizer=dict(
        lr_max="OPTIMIZE: lambda idx: float(10 ** idx) # continuous # (-6, -1)",
