...
hyperparameters = dict(
    model_name="LMFDB_range_Matthews_NN_p1000-ver2",
    model_num=None,
    ...
    model=dict(
        ...
        output_layers="OPTIMIZE: lambda idx: int(idx) # discrete # tuple(range(6))",
    ...
    optimizer=dict(
        lr_max="OPTIMIZE: lambda idx: float(10 ** idx) # continuous # (-5, -1)",
