...
hyperparameters = dict(
    model_name=f"triv_5_range_Matthews_Nsum_4_p{max_prime}",
    model_num=None,
    ...
    dataloader=dict(
        ...
        min_max_conductor=[1, 10**29],
        min_max_test_conductor=[10**29+1, 10**30],
        curves_count=None,
        ...
        load_S4_S5_sums=f"od_Matije/curves_r01triv_svi_union_Nsums_S4_S5_p{max_prime}.json",
        load_Bober_sums=f"Bober_sums/triv_union_{max_prime}.txt",
